                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.orders.update", [$order->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('client_fullname') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="client_fullname" id="client_fullname" value="{{ old('client_fullname', $order->client_fullname) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('phone_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $order->phone_number) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('comment') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="comment" id="comment">{{ old('comment', $order->comment) }}</textarea>
